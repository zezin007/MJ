...
function verificarResposta(resposta) {
    ...
    if (opcoesCorretas.includes(resposta)) {
        if (resposta === '1') {
            mensagem.innerText = 'Obvio que é em você, penso em ti 24h por segundo!';
            gif.style.display = 'block';
            setTimeout(function() {
                window.location.href = 'pergunta6.html'; // Redireciona para a próxima página após 3 segundos
            }, 4000); // Delay de 3 segundos
        } else if (resposta === '3') {
            mensagem.innerText = '';
            setTimeout(function() {
                window.location.href = 'comidadiferente.html'; // Redireciona para outra página após 3 segundos
